...
namespace Library.Repositories.Migrations
{
    ...
    [Migration("20250709034819_UpdateApplicationUser")]
            ...
            modelBuilder.Entity("Library.Models.DivisionStaff", b =>
                {
                    b.HasOne("Library.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("Library.Models.DivisionStaff", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Library.Models.EventParticipant", b =>
                {
                    b.HasOne("Library.Models.ApplicationUser", "ApplicationUser")
                        .WithOne("Participant")
                        .HasForeignKey("Library.Models.EventParticipant", "ApplicationUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Library.Models.Member", b =>
                {
                    b.HasOne("Library.Models.ApplicationUser", "ApplicationUser")
                        ...
                        .HasForeignKey("Library.Models.Member", "ApplicatioUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
